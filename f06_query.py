...
class F06Query:
    ...
    def _read_msc(self, lines):
        ...
        while line_no < len(lines):
            ...
            elif "F O R C E S   I N   Q U A D R I L A T E R A L   E L E M E N T S   ( Q U A D 4 )        OPTION = BILIN" in line:
                if is_mode_block():
                    continue
                prefix = subcase_mode()
                eids_node = self.ensure_path(root, prefix + ["SHELLFORCES","EID"])
            ...
            elif "F O R C E S   I N   Q U A D R I L A T E R A L   E L E M E N T S   ( Q U A D 4 )" in line \
            or   "F O R C E S   I N   T R I A N G U L A R   E L E M E N T S   ( T R I A 3 )" in line:
                if is_mode_block():
                    continue
                prefix = subcase_mode()
                eids_node = self.ensure_path(root, prefix + ["SHELLFORCES","EID"])
